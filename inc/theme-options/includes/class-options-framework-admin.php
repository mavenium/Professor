...
class Options_Framework_Admin {
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'ذخیره تنظیمات' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'بازگردانی پیشفرض ها' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'همه تنظیمات از دست خواهد رفت !' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'گزینه های پیش فرض دوباره بازسازی شد.' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'تنظیمات ذخیره شد.' ), 'updated fade' );
	}
